...
public class SalesInput1New extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    TextView serial,opening,closing,consumption;
    int opening1,closing1 ,consumption1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sales_input1_new);
...
//        Toast.makeText(this, opening1+","+closing1, Toast.LENGTH_SHORT).show();
//        if(opening1!=0 && closing1!=0)
//        {
//            Toast.makeText(this, opening1+","+closing1, Toast.LENGTH_SHORT).show();
//            int consume= opening1-closing1;
//            Toast.makeText(this, consume+"", Toast.LENGTH_SHORT).show();
//        }
...
//            color = Color.WHITE;
            ...
            Toast.makeText(SalesInput1New.this, message, Toast.LENGTH_SHORT).show();
...
//                String id = jo.getString(Config.TAG_ID);
                 opening1 = jo.getInt("machine_daycounter");

//                Toast.makeText(this, opening1+"", Toast.LENGTH_SHORT).show();
            }
    ...
    private void getOverallOpening(){
        ...
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SalesInput1New.this,"Fetching Overall Reading","Please Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam(AppConfig.URL_OVERALL_OPENING, sno);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
    ...
    private void showClosing(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                JSONObject jo = result.getJSONObject(i);
//                String id = jo.getString(Config.TAG_ID);
                closing1 = jo.getInt("machine_daycounter");
//                Toast.makeText(this, closing1+","+opening1, Toast.LENGTH_SHORT).show();

                opening.setText(String.valueOf(opening1));
                closing.setText(String.valueOf(closing1));
                consumption1=closing1-opening1;
                consumption.setText(String.valueOf(consumption1));
    ...
    private void getOverallClosing(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam(AppConfig.URL_OVERALL_CLOSING, sno);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
...
//                String s = rh.sendGetRequestParam(AppConfig.URL_GET_USER_ALL, catid, subcatid);
                String s = rh.sendGetRequestParam(AppConfig.URL_GET_ALL_NEW, sno);
                return s;
            }
        }
...
//                androidVersion.setStatus(status[i]);
        ...
        //        ArrayList<Data> androidVersions = prepareData();
        SalesInput_Adapter adapter = new SalesInput_Adapter(SalesInput1New.this, android_version);
        recyclerView.setAdapter(adapter);
//        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
//            @Override
//            public void onClick(View view, int position) {
...
//            Toast.makeText(Parks.this, name+"", Toast.LENGTH_SHORT).show();
    ...
    private String getOpeing(JSONObject j){
        String prod_no = null;
        try {
            prod_no = j.getString("Opening_Reading");
//            Toast.makeText(Parks.this, name+"", Toast.LENGTH_SHORT).show();
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    private String getClosing(JSONObject j){
        String desc = null;
        try {
            desc = j.getString("Closing_Reading");
//            Toast.makeText(Parks.this, name+"", Toast.LENGTH_SHORT).show();
        } catch (JSONException e) {
            e.printStackTrace();
        }
...
//
//            Intent intent = new Intent(SalesInput1New.this, LiveSales.class);
//            intent.putExtra("cus_id", cus_id);
//            intent.putExtra("lavazza", lavazza);
//            startActivity(intent);
//            finish();
...
//        {
//
//            Intent intent = new Intent(SalesInput1New.this, LiveSalesSE.class);
//            intent.putExtra("cus_id", cus_id);
//            intent.putExtra("lavazza", lavazza);
//            startActivity(intent);
//            finish();
...
//        }
        ...
        {
            finish();
//            Intent intent = new Intent(SalesInput1New.this,MainActivity.class);
...
//            }
        ...
        {
            Intent intent=new Intent(SalesInput1New.this,Graph.class);
            startActivity(intent);
        }
        return super.onOptionsItemSelected(item);
    }

...
//            ab.setTitle(Html.fromHtml("<font color='#0e2c4d'>Customer Portal</font>"));
//            ab.setTitle(name);
        }

        mWebView= (WebView) findViewById(R.id.webview);
        startWebView("https://lavazzaindia.custhelp.com");
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(CustomerPortal.this);

 ...
 */
//public class ManagerFragment extends Fragment implements ViewPager.OnPageChangeListener{
public class ManagerFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{

    GridView gridView;
    public static String [] nameList={"Live Sales","Product","Services","Feedback"};
    public static int [] images={R.drawable.sales,R.drawable.product1,R.drawable.services_1,R.drawable.feedback2};
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i) {
                    case 0:
                        ...
                        {
                            Intent intent4 = new Intent(getActivity().getApplication(), LiveSales.class);
                        ...
                        startActivity(intent4);
                            ...
                            Intent intent4 = new Intent(getActivity().getApplication(), LiveSalesSE.class);
                            Bundle bundle = new Bundle();
                            bundle.putString("cus_id", cus_id);
                            bundle.putString("lavazza", lavazza);
                            intent4.putExtras(bundle);
...
//                        startActivity(intent1);
                    ...
                    case 3:
                        view.startAnimation(AnimationUtils.loadAnimation(getActivity().getApplication(), R.anim.image_click));
                        Intent intent2= new Intent(getActivity().getApplication(),FeedBack.class);
